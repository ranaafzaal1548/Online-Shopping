...
public final class editProduct_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <center><h2> Welcome to Online shopping </h2></center>\r\n");
      ...
      out.write("          <p>All Right Reserved @ Taqasur</p>\r\n");
      out.write("      </div>");
      out.write("\r\n");
      out.write("<html>\r\n");
      out.write("<head>\r\n");
...
try{
    Connection con=connectionproviderclass.getcon();
        ...
        ResultSet rs=st.executeQuery("select *from from product where id='"+id+"'");
        while(rs.next()){

      out.write("  \r\n");
      out.write("\r\n");
      out.write("<form action=\"editProductAction.jsp\" method=\"post\">\r\n");
      out.write("    <input type=\"\" name=\"id\" value=\"");
out.println(id);
      out.write("\">\r\n");
